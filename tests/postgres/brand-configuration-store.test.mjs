  ...
  try {
    ...
    await client.query(
      `INSERT INTO core_config.brand_configuration
       ...
       VALUES
        ($1,'INDUSTRY',$6,$8,$11,2,'ACTIVE',
          '{"primary":"#06B6D4","security":{"danger":"#DC2626"}}'::jsonb,
          '{"primary":"Inter","heading":"Poppins"}'::jsonb,$12,$13,'PASS',$14,$15,
          now()-interval '10 days',now()-interval '1 day'),
        ($2,'INDUSTRY',$6,$9,$16,1,'PUBLISHED',
          '{"warning":"#000000"}'::jsonb,'{"primary":""}'::jsonb,NULL,NULL,'PENDING',$14,NULL,
          now()-interval '8 days',now()-interval '2 days'),
        ($3,'TENANT',$6,NULL,'',3,'DRAFT',
          '{"raw":{"empty":"","nullable":null},"danger":"#FFFFFF"}'::jsonb,
          '{"font":"","fallbacks":["Inter",null,"Inter"]}'::jsonb,NULL,NULL,'FAIL',$14,NULL,
          now()-interval '6 days',now()-interval '3 days'),
        ($4,'TENANT',$7,NULL,$17,1,'ACTIVE',
          '{"primary":"#123456"}'::jsonb,'{"primary":"Inter"}'::jsonb,NULL,NULL,'PASS',$14,$15,
          now()-interval '5 days',now()-interval '1 day'),
        ($5,'PLATFORM',NULL,NULL,$18,4,'ACTIVE',
          '{"product":"SBGlobal Plus","danger":"#DC2626"}'::jsonb,
          '{"primary":"Inter"}'::jsonb,$19,NULL,'PASS',$14,$15,
