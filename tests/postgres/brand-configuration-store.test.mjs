      ...
      `INSERT INTO core_config.brand_configuration
       ...
       VALUES
        ($1,'INDUSTRY',$6,$8,$10,2,'ACTIVE',
          ...
          '{"primary":"Inter","heading":"Poppins"}'::jsonb,$10,$10,'PASS',$10,$10,
          now()-interval '10 days',now()-interval '1 day'),
        ($2,'INDUSTRY',$6,$9,$10,1,'PUBLISHED',
          '{"warning":"#000000"}'::jsonb,'{"primary":""}'::jsonb,NULL,NULL,'PENDING',$10,NULL,
          now()-interval '8 days',now()-interval '2 days'),
        ($3,'TENANT',$6,NULL,'',3,'DRAFT',
          '{"raw":{"empty":"","nullable":null},"danger":"#FFFFFF"}'::jsonb,
          '{"font":"","fallbacks":["Inter",null,"Inter"]}'::jsonb,NULL,NULL,'FAIL',$10,NULL,
          now()-interval '6 days',now()-interval '3 days'),
        ($4,'TENANT',$7,NULL,$10,1,'ACTIVE',
          '{"primary":"#123456"}'::jsonb,'{"primary":"Inter"}'::jsonb,NULL,NULL,'PASS',$10,$10,
          now()-interval '5 days',now()-interval '1 day'),
        ($5,'PLATFORM',NULL,NULL,$10,4,'ACTIVE',
          '{"product":"SBGlobal Plus","danger":"#DC2626"}'::jsonb,
          '{"primary":"Inter"}'::jsonb,$10,NULL,'PASS',$10,$10,
