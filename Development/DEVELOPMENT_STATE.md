...
The latest product decision remains DD-079. Verification work implements existing
MI/DD acceptance requirements and does not create a new domain decision.
