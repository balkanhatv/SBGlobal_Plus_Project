...
DD-145 adds an exact internal API Credential metadata reader through the dedicated Identity-service role, excludes `secret_hash`, and preserves raw persisted scope/version/status/CIDR evidence without inventing machine-authentication or credential-lifecycle semantics.
