...
**Document ID:** F-01 · **Version:** 0.4 · **Status:** SPECIFIED — REMEDIATION REVALIDATED (CERTIFICATION PENDING) · Cross-refs: F-00 (authority/current status), F-02 (lifecycle), F-03 (identity/security), F-04 (data), F-05 (AI), F-06 (experiences), F-15 (truth revalidation).
