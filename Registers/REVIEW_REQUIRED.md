...
**Updated:** 2026-09-20 · **Current checkpoint:** `DEV-COMMERCIAL-PLAN-CHANGE-EVIDENCE-001`

Current Development evidence is [CORE_SERVICE_CHECKPOINT](../Development/CORE_SERVICE_CHECKPOINT.md): verified executable `b77f6ce8cd7fcf0617369a0786dea15113a7b72b` / tree `2130302dc137399724da7082a7212dc3d75db2fe`, with Core **184/184 PASS**, PostgreSQL **49/49 PASS**, Database **45 migrations / 39 verification files PASS**, and Next.js 15.5.25 production build / deterministic npm lock / generated-state cleanliness **PASS**. The active checkpoint is `DEV-COMMERCIAL-PLAN-CHANGE-EVIDENCE-001`: DD-066 evidence persistence and producer isolation are verified, but impact/remediation evaluation and actual Billing/payment/Workflow approval producer runtimes remain unfinished. Public `core.commercial.subscription.changePlan` remains unbound. Earlier pre-development and Database sections below retain their historical scope.
