...
**Updated:** 2026-09-20 · **Current checkpoint:** `DEV-COMMERCIAL-ADJUSTMENT-SCHEMA-001`

Current Development evidence is [CORE_SERVICE_CHECKPOINT](../Development/CORE_SERVICE_CHECKPOINT.md): verified executable `4a526c8fc9287136ffad0ee723c73df536a50b27` / tree `1496cb8d43be198edd71cef62171ced096bfc607`, with Core **193/193 PASS**, PostgreSQL **49/49 PASS**, Database **45 migrations / 39 verification files PASS**, and Next.js 15.5.25 production build / deterministic npm lock / generated-state cleanliness **PASS**. The active checkpoint is `DEV-COMMERCIAL-ADJUSTMENT-SCHEMA-001`: DD-069 quota-additive add-on and typed override normalization are verified. Add-on eligibility, active source reads, precedence, compliance/security restrictions, usage impact and actual Billing/payment/Workflow approval runtimes remain unfinished. Public `core.commercial.subscription.changePlan` remains unbound. Earlier pre-development and Database sections below retain their historical scope.
