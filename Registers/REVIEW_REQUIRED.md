...
**Updated:** 2026-09-20 · **Current checkpoint:** `DEV-COMMERCIAL-PLAN-BASELINE-001`

Current Development evidence is [CORE_SERVICE_CHECKPOINT](../Development/CORE_SERVICE_CHECKPOINT.md): verified executable `8f9e7a23e2b383eb7cb3e964d8ed57e35678d2e4` / tree `eab90b5ad7c269994686790e1d76c2c90b7953a6`, with Core **190/190 PASS**, PostgreSQL **49/49 PASS**, Database **45 migrations / 39 verification files PASS**, and Next.js 15.5.25 production build / deterministic npm lock / generated-state cleanliness **PASS**. The active checkpoint is `DEV-COMMERCIAL-PLAN-BASELINE-001`: DD-067 PlanVersion schema and DD-068 licensed baseline expansion are verified. Full target preview still requires add-on/override normalization, compliance/security restriction inputs and usage-impact evaluation; actual Billing/payment/Workflow approval runtimes also remain unfinished. Public `core.commercial.subscription.changePlan` remains unbound. Earlier pre-development and Database sections below retain their historical scope.
