...
Read `Development/TENANT_INTEGRATION_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` before extending TenantIntegration behavior. DD-095 is raw RLS persistence only; status/health/capability evidence does not authorize runtime execution and CredentialReference secret metadata is not read.
