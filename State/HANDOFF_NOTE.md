...
Read `Development/DOCUMENT_STORAGE_BINDING_PREREQUISITE_OWNERSHIP_AUDIT.md` before extending storage access. Physical object metadata is reachable only through an RLS-visible linked DocumentMeta row and remains server-private. DD-085/084 remain non-authorizing ACL evidence boundaries.
