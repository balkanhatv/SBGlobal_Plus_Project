...
Read `Development/REST_ADAPTER_PREREQUISITE_OWNERSHIP_AUDIT.md` before mounting REST. Read `Development/COMMERCIAL_EVALUATOR_PREREQUISITE_OWNERSHIP_AUDIT.md` before attempting the concrete evaluator. Both documents name the remaining dependencies; guessed defaults are not authorized.
