...
Read `Development/AI_PROVISIONING_SNAPSHOT_RAW_PERSISTENCE_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` and `Registers/DEVELOPMENT_DD124_VERIFICATION_2026-09-23.md` before extending AI behavior.
