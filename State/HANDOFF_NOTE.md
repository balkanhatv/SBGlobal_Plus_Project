...
Read `Development/AI_PROMPT_SET_RAW_PERSISTENCE_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` and `Registers/DEVELOPMENT_DD112_VERIFICATION_2026-09-23.md` before extending AI prompt behavior.
