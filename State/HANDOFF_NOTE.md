...
Read `Development/AI_INDUSTRY_CONFIG_RAW_PERSISTENCE_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` and `Registers/DEVELOPMENT_DD120_VERIFICATION_2026-09-23.md` before extending AI behavior.
