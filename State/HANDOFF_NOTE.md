...
Read `Development/AI_TENANT_CONFIG_RAW_PERSISTENCE_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` and `Registers/DEVELOPMENT_DD119_VERIFICATION_2026-09-23.md` before extending AI behavior.
