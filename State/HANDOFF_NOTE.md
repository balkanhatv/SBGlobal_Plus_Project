...
Read `Development/AI_PROVIDER_CATALOG_METADATA_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` and `Registers/DEVELOPMENT_DD107_VERIFICATION_2026-09-22.md` before extending AI behavior.
