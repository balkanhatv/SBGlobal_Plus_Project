...
Read `Development/DOCUMENT_ACL_SUBJECT_MATCH_PREREQUISITE_OWNERSHIP_AUDIT.md` before extending ACL evaluation. DD-085 only matches resolved server-owned identities; it deliberately preserves and does not interpret effect/validUntil. DD-084 remains the raw persistence evidence boundary.
