...
Read `Development/WEBHOOK_DELIVERY_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` before extending delivery behavior. DD-089 exposes persisted attempt evidence only; raw status/http/error/nextAttempt fields are not permission to retry, deliver, DLQ or replay.
