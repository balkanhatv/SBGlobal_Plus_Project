...
Read `Development/WORKFLOW_INSTANCE_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` before extending Workflow behavior. DD-102 is raw persistence only: current/lifecycle state and rowVersion do not authorize transitions or task actions.
