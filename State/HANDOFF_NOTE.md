...
Read `Development/AI_TOOL_SET_MEMBER_RAW_PERSISTENCE_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` and `Registers/DEVELOPMENT_DD113_VERIFICATION_2026-09-23.md` before extending AI behavior.
