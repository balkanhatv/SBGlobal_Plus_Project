...
Read `Development/BRAND_CONFIGURATION_RAW_PERSISTENCE_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` and `Registers/DEVELOPMENT_DD139_VERIFICATION_2026-09-23.md` before extending brand behavior.
