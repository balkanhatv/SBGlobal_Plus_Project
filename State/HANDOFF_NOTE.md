...
Read `Development/COUNTRY_PACK_RAW_PERSISTENCE_READER_PREREQUISITE_OWNERSHIP_AUDIT.md` and `Registers/DEVELOPMENT_DD137_VERIFICATION_2026-09-23.md` before extending CountryPack behavior.
