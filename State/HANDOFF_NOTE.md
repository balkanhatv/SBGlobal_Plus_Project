...
Read `Development/DOCUMENT_ACCESS_CANDIDATE_PREREQUISITE_OWNERSHIP_AUDIT.md` before extending Document signing. It explicitly separates the implemented metadata/state candidate floor from unresolved permission/step-up/TTL/provider signing semantics. Existing REST, Commercial evaluator, AI Gateway and Event prerequisite audits remain authoritative for their blocked scopes.
