...
**Updated:** 2026-09-24 · **Current checkpoint:** `DEV-API-CREDENTIAL-CURRENT-LIFECYCLE-FLOOR-001`
...
DD-158 adds only the API Credential status/expiry necessary lifecycle floor. Matching currentness does not verify secret material or authenticate a machine credential.

Next: Fresh source-audit the next runtime prerequisite. Keep token parsing, approved verifier execution, CIDR, principal/scope/profile mapping, usage/audit and final machine evidence outside scope unless separately source-owned.
