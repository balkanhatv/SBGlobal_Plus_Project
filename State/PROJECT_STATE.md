...
Integration registry/raw persistence coverage now includes EventCatalog, IntegrationDefinition, IntegrationCapability, ProviderAdapter, TenantIntegration, credential metadata and SyncCursor. Runtime provider/secret/sync authority remains intentionally separate.
