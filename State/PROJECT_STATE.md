...
DD-151 adds only exact selected-id necessary equality; no trusted selection or access grant is implied.
...
Next: Fresh source-audit the next runtime prerequisite. Trusted selection, floor composition, step-up, permission profile, approval/purpose policy, request scope and mandatory audit remain separate.
