...
DD-147 adds a server-internal API Credential verification-material lookup by exact persisted unique prefix. Verifier hash material remains internal and does not itself authenticate or authorize.
...
Next: Fresh source-audit the next runtime prerequisite. Keep full machine-token parsing/verifier execution/CIDR/lifecycle/usage-audit/evidence construction outside scope unless separately source-owned.
