...
Notification send/retry/provider runtime, template rendering policy and other named
REST/Commercial/AI/Event/Document unfinished scopes remain unclaimed.
